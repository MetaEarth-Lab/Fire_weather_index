...
def DMC(TEMP, RH, RAIN, DMCPrev, LAT, numb_day, MONTH):
    """
    ...
    d1 = DayLength(LAT, numb_day, MONTH)
    k[ind_TEMPG11] = (
        1.894
...
def DayLength(Latitude, numb_day, MONTH):
    """
...
def DC_with_overwintering(
    ...
    dc[ind_TT] = DC(
        TEMP[ind_TT], RAIN[ind_TT], dcPREV[ind_TT], LAT[ind_TT], MONTH
    )  # (case 1.1)
